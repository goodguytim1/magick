...
export default function BusinessManager() {
  ...
  const saveBusiness = async () => {
    ...
    try {
      ...
      const catalogData = await AsyncStorage.getItem('jacksonville_catalog');
      const catalog = catalogData ? JSON.parse(catalogData) : [];

      // Add new business
      catalog.push(newBusiness);

      // Save updated catalog
      await AsyncStorage.setItem('jacksonville_catalog', JSON.stringify(catalog));
